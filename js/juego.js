...
class EscenaJuego extends Phaser.Scene {
    ...
    escribirMensajePerro() {
        ...
        this.txtPerro = this.add.text(this.perro.x, this.perro.y - 120, "", { fontSize: '24px', fill: '#ffd700', fontFamily: 'Cinzel Decorative', align: 'center', stroke: '#000', strokeThickness: 5 }).setOrigin(0.5).setDepth(9999);
    ...
    mostrarBotonesFinales() {
        ...
        bC.on('pointerup', () => { window.open('https://wa.me/34600000000', '_blank'); });
        bM.on('pointerup', () => { window.open('https://maps.app.goo.gl/TU_LINK', '_blank'); });
    }
}
